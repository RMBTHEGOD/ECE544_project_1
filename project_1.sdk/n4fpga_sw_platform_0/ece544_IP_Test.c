...
uint16_t volatile total_time;
uint32_t volatile prev_gpio_in;
}Time;// Structure to hold the high and the low time
Time volatile r_colour_time,g_colour_time,b_colour_time;
...
void RunTest4(void)
{
	...
	while(1) {
	    ...
	    float duty_cycle_red=((r_colour_time.total_time==0)?0:((float)r_colour_time.colour_time.high_time)/r_colour_time.total_time)*100;
	    float duty_cycle_green=((g_colour_time.total_time==0)?0:((float)g_colour_time.colour_time.high_time)/g_colour_time.total_time)*100;
	    float duty_cycle_blue=((b_colour_time.total_time==0)?0:((float)b_colour_time.colour_time.high_time)/b_colour_time.total_time)*100;
	    //xil_printf("high_time=%d\n",b_colour_time.colour_time.high_time);
	    //xil_printf("low_time=%d\n",b_colour_time.colour_time.low_time);
	    //xil_printf("prev_gpio=%d",b_colour_time.prev_gpio_in);
	    //xil_printf("total time=%d",b_colour_time.total_time);
