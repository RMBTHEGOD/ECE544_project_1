...
HD_PWD='G:/ECE544/project_1/project_1.runs/embsys_microblaze_0_xlconcat_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_microblaze_0_xlconcat_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_microblaze_0_xlconcat_0.tcl
