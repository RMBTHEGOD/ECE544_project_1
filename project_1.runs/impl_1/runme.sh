...
HD_PWD='G:/ECE544/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log n4fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source n4fpga.tcl -notrace
