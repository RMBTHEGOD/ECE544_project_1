...
HD_PWD='G:/ECE544/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log n4fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source n4fpga.tcl
