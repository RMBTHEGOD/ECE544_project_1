...
// n4fpga.v - Top level module for the Embedded system
//
// Copyright Rithvik Mitresh Ballal, Portland State University, 2018
// 
// Created By:	Roy Kravitz
// Modified By: Chetan Bornarkar, 2016
//              Rithvik Mitresh Ballal,2018
// Date:		24-January-2018
// Version:		3.0
//
// Description:
// ------------
// This module provides the top level for the Embedded system.
...
wire    [31:0]      gpio_red_high_time;     //holds the high time for red colour
wire    [31:0]      gpio_red_low_time;      //holds the low time for red colour
wire    [31:0]      gpio_blue_high_time;    //holds the high time for blue colour
wire    [31:0]      gpio_blue_low_time;     //holds the low time for blue colour
wire    [31:0]      gpio_green_high_time;   //holds the high time for green colour
wire    [31:0]      gpio_green_low_time;    //holds the low time for green colour
// OLED pins 
...
embsys EMBSYS
       (// PMOD OLED pins 
        ...
        .gpio_0_red_high_tri_i(gpio_red_high_time),
        .gpio_0_red_low_tri_i(gpio_red_low_time),
        .gpio_0_green_high_tri_i(gpio_green_high_time),
        .gpio_0_green_low_tri_i(gpio_green_low_time),
        .gpio_0_blue_high_tri_i(gpio_blue_high_time),
        .gpio_0_blue_low_tri_i(gpio_blue_low_time),
        // Pmod Rotary Encoder
...
// instantiating pwm detection module for individual colour(RGB)
pwm_detection pwdr(.gpio_high_time(gpio_red_high_time),
.gpio_low_time(gpio_red_low_time),.gpio(w_RGB1_Red),.clock(colour_clock));
pwm_detection pwdb(.gpio_high_time(gpio_blue_high_time),
.gpio_low_time(gpio_blue_low_time),.gpio(w_RGB1_Blue),.clock(colour_clock));
pwm_detection pwdg(.gpio_high_time(gpio_green_high_time),
.gpio_low_time(gpio_green_low_time),.gpio(w_RGB1_Green),.clock(colour_clock));
