...
wire    [15:0]      gpio_red_high_time;     //holds the high time for red colour
wire    [15:0]      gpio_red_low_time;      //holds the low time for red colour
wire    [15:0]      gpio_blue_high_time;    //holds the high time for blue colour
wire    [15:0]      gpio_blue_low_time;     //holds the low time for blue colour
wire    [15:0]      gpio_green_high_time;   //holds the high time for green colour
wire    [15:0]      gpio_green_low_time;    //holds the low time for green colour
// OLED pins 
...
.gpio_low_time(gpio_red_low_time),.gpio(w_RGB1_Red),.clock(sysclk));
pwm_detection pwdb(.gpio_high_time(gpio_blue_high_time),
.gpio_low_time(gpio_blue_low_time),.gpio(w_RGB1_Blue),.clock(sysclk));
pwm_detection pwdg(.gpio_high_time(gpio_green_high_time),
.gpio_low_time(gpio_green_low_time),.gpio(w_RGB1_Green),.clock(sysclk));
